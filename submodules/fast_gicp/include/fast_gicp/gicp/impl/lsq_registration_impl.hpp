...
template <typename PointTarget, typename PointSource>
void LsqRegistration<PointTarget, PointSource>::setMaxIteration(int input) {
  max_iterations_ = input;
}

template <typename PointTarget, typename PointSource>
void LsqRegistration<PointTarget, PointSource>::setMinIteration(int input) {
  min_iterations_ = input;
}
...
template <typename PointTarget, typename PointSource>
bool LsqRegistration<PointTarget, PointSource>::isConverged() {
  return converged_;
}
