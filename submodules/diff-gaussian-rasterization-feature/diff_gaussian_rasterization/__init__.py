    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                ...
                num_rendered, color, feature_map, depth, radii, geomBuffer, binningBuffer, imgBuffer, out_opacity = _C.rasterize_gaussians(*args)
            ...
            # num_rendered, color, feature_map, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args) ###############
            num_rendered, color, feature_map, depth, radii, geomBuffer, binningBuffer, imgBuffer, out_opacity = _C.rasterize_gaussians(*args) ###d
        ...
        return color, feature_map, radii, depth, out_opacity

    @staticmethod
    ### def backward(ctx, grad_out_color, _):
    # def backward(ctx, grad_out_color, grad_out_feature, _): ###############
    def backward(ctx, grad_out_color, grad_out_feature, _, grad_depth, grad_opacity): ###d
        ...
        if raster_settings.debug:
            ...
            try:
                ...
                grad_means2D, grad_colors_precomp, grad_semantic_feature, grad_opacities, grad_means3D, grad_cov3Ds_precomp, grad_sh, grad_scales, grad_rotations, grad_tau = _C.rasterize_gaussians_backward(*args) ###d
            except Exception as ex:
...
class GaussianRasterizer(nn.Module):
    ...
    def markVisible(self, positions):
        ...
        return visible
    ### ADDED FEATURE
    def forward(self, means3D, means2D, opacities, shs = None, semantic_feature = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None, theta=None, rho=None): ###d
