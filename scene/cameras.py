...
class Camera():
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, depth_image, gt_alpha_mask,
        ...
        self.original_image = image.clamp(0.0, 1.0).to('cuda:0')
        self.original_depth_image = depth_image.to('cuda:0')
        ...
        # Keyframe type: 'tracking' or 'mapping'
        self.keyframe_type = 'tracking'  # default to tracking
...
class MiniCam:
    def __init__(self, width, height, fovy, fovx, znear, zfar, world_view_transform, full_proj_transform):
        ...
        # Camera pose delta parameters (same as SharedCam)
