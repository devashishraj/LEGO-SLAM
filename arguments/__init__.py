...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_init = 0.00016 # 0.000016
        self.position_lr_final = 0.00016 # 0.0000016
...
class SLAMParameters():
    def __init__(self):
        ...
        self.keyframe_freq = 30  # replica : 10, tum : 10
        self.train = True
